...
function AiCodeReviewer({ filename, code, language, onApplyFix, projectId }) {
    ...
    return (
        <div className="w-[360px] bg-surface border-l border-border-subtle flex flex-col">
            ...
            <div className="px-5 py-4 border-b border-border-subtle">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="text-sm text-primary hover:bg-primary-soft bg-transparent border border-primary/20 px-3 py-1 rounded disabled:opacity-50 transition"
                    >
            ...
            {isAnalyzing ? (
                loading ? (
                    <div className="flex-1 flex flex-col items-center justify-center space-y-4">
                        ...
                        <p className="text-sm text-text-muted">Analyzing code...</p>
                    </div>
                ) : error ? (
                    <div className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-4">
                        ...
                        <button
                            onClick={handleRunTestCases}
                            className="text-xs bg-surface border border-border-subtle hover:bg-hover-bg px-4 py-2 rounded text-text-primary transition"
                        >
                            Retry
                        </button>
                    </div>
