...
import { MessageSquare, Bot, Hash, Code, Sparkles, Terminal } from "lucide-react";
...
function NoChatSelected() {
    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 bg-background relative overflow-hidden select-none">
            {/* Glowing blur effects behind content */}
            ...
            >
                ...
                >
                    Welcome to <span className="bg-gradient-to-r from-primary via-info to-purple-500 bg-clip-text text-transparent">DevCollab Chat</span>
                </motion.h1>
                ...
                >
                    Real-time conversations, team channels, and repository-aware AI tools all built in one powerful SaaS environment.
                </motion.p>
                ...
                >
                    <div className="bg-card border border-border-subtle rounded-2xl p-5 text-left hover:border-border-default hover:shadow-md transition-all duration-300 group">
                        ...
                        <h3 className="text-sm font-bold text-text-primary mb-1">AI Integration</h3>
                        <p className="text-xs text-text-muted leading-relaxed">Type <code className="bg-hover-bg px-1.5 py-0.5 rounded font-mono text-[11px] text-primary">@ai</code> in any text box to invoke Gemini models.</p>
                    </div>
                    ...
                    <div className="bg-card border border-border-subtle rounded-2xl p-5 text-left hover:border-border-default hover:shadow-md transition-all duration-300 group">
                        ...
                        <h3 className="text-sm font-bold text-text-primary mb-1">Team Spaces</h3>
                        <p className="text-xs text-text-muted leading-relaxed">Organize projects, tasks and features within modular workspaces.</p>
                    </div>
                    ...
                    <div className="bg-card border border-border-subtle rounded-2xl p-5 text-left hover:border-border-default hover:shadow-md transition-all duration-300 group">
                        ...
                        <h3 className="text-sm font-bold text-text-primary mb-1">Code Centric</h3>
                        <p className="text-xs text-text-muted leading-relaxed">Share, highlight, and review code blocks with high-end syntax tools.</p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <span>Socket server: Connected & Online</span>
                </motion.div>
            </motion.div>
        </div>
    );
